;;; pls-theme-zenburn.el --- A low contrast color theme for Emacs.
;;; based on zenburn.el
...
(deftheme pls-zenburn "The Zenburn color theme, as modified by pls")

;;; Color Palette

(defvar pls-zenburn-colors-alist
  '(("zenburn-fg+1"     . "#FFFFEF")
    ("zenburn-fg"       . "#DCDCCC")
    ("zenburn-fg-1"     . "#656555")
    ...
    ("pls-zenburn-blue" .    "#0039A6")
    ("pls-zenburn-gray" .    "#394A59")
    ("pls-zenburn-gray2" .   "#5F6A72")
    ("pls-zenburn-gray3" .   "#A5ACB0")
    ("pls-zenburn-gray4" .   "#E2E1DD")
    ("pls-zenburn-red" .     "#462324")
    ("pls-zenburn-red2" .    "#9E1B32")
    ("pls-zenburn-red3" .    "#C3267B")
    ("pls-zenburn-red4" .    "#E70033")
    ("pls-zenburn-orange" .  "#E24912")
    ("pls-zenburn-orange2" . "#FFA200")
    ("pls-zenburn-yellow" .  "#F6DA14")
    ("pls-zenburn-yellow2" . "#FBDE81")
    ("pls-zenburn-yellow3" . "#EEE8C5")
    ("pls-zenburn-green" .   "#214232")
    ("pls-zenburn-green2" .  "#77B800")
    ("pls-zenburn-green3" .  "#CFEA8B")
    ("pls-zenburn-green4" .  "#007165")
    ("pls-zenburn-green5" .  "#003D4D")
    ("pls-zenburn-blue2" .   "#0091B5")
    ("pls-zenburn-blue3" .   "#002144")
    ("pls-zenburn-blue4" .   "#0096DB")
    ("pls-zenburn-blue5" .   "#97C5EB")
    ("pls-zenburn-blue6" .   "#BADCE6")
    ("pls-zenburn-purple" .  "#580F8B")
    ...
    ;; ("zenburn-orange"   . "#DF8F59")
    ("zenburn-orange"   . "#DF6716")


    ;; ("zenburn-yellow"   . "#F0DFAF")
    ("zenburn-yellow"   . "#FBDE81")
...
(defmacro pls-zenburn-with-color-variables (&rest body)
  "`let' bind all colors defined in `pls-zenburn-colors-alist' around BODY.
Also bind `class' to ((class color) (min-colors 89))."
  (declare (indent 0))
  `(let ((class '((class color) (min-colors 89)))
         ,@(mapcar (lambda (cons)
                     (list (intern (car cons)) (cdr cons)))
                   pls-zenburn-colors-alist))
     ,@body))

;;; Theme Faces
(pls-zenburn-with-color-variables
...
;;;;; basic coloring
   ...
   `(link-visited ((t (:foreground ,zenburn-yellow-2 :underline t
                                   :weight normal))))
   `(default ((t (:foreground ,zenburn-fg+1 :background ,zenburn-bg-1))))
...
;;;;; compilation
   ...
   `(compilation-error-face ((t (:foreground ,zenburn-red-1 :weight
                                             bold :underline t))))
   ...
   `(compilation-warning-face ((t (:foreground ,zenburn-orange :weight
                                               bold :underline t))))
   `(compilation-mode-line-exit ((t (:foreground ,zenburn-green+2
                                                 :weight bold))))
...
;;;;; grep
   ...
   `(grep-error-face ((t (:foreground ,zenburn-red-1 :weight bold
                                      :underline t))))
   `(grep-hit-face ((t (:foreground ,zenburn-blue))))
   `(grep-match-face ((t (:foreground ,zenburn-orange :weight bold))))
   `(match ((t (:background ,zenburn-bg-1 :foreground ,zenburn-orange
                            :weight bold))))
;;;;; isearch
   `(isearch ((t (:foreground ,zenburn-yellow-2 :weight bold
                              :background ,zenburn-bg+2))))
   `(isearch-fail ((t (:foreground ,zenburn-fg :background ,zenburn-red-4))))
   `(lazy-highlight ((t (:foreground ,zenburn-yellow-2 :weight bold
   ...
   ;; darker colors
   `(mode-line
     ((,class (:foreground ,zenburn-blue-3 ;;pls-zenburn-green5
                           :background ,zenburn-bg-2
                           :box (:line-width 6 :color ,zenburn-bg-2
                                             :style nil)))
      (t :inverse-video t)))
   `(mode-line-inactive
     ((t (:foreground ,zenburn-blue-3 ;;pls-zenburn-green4
                      :background ,zenburn-bg-05
                      :box (:line-width 6 :color ,zenburn-bg-05 :style nil)))))
   ;; lighter colors
   ;; `(mode-line
   ;;   ((,class (:foreground ,zenburn-bg-2 ;;pls-zenburn-green5
   ;;        :background ,zenburn-blue-3
   ;;        :box (:line-width 6 :color ,zenburn-blue-3
   ;;          :style nil)))
   ;;    (t :inverse-video t)))
   ;; `(mode-line-inactive
   ;;   ((t (:foreground ,zenburn-bg-2 ;;pls-zenburn-green4
   ;;           :background ,zenburn-bg-05
   ;;           :box (:line-width 6 :color ,zenburn-bg-05 :style nil)))))



   `(region ((,class (:background ,zenburn-bg))
             (t :inverse-video t)))
...
;;;;; font lock
   ...
   `(font-lock-comment-face ((t (:foreground ,pls-zenburn-green2))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,pls-zenburn-green2))))
   `(font-lock-constant-face ((t (:foreground ,zenburn-blue))))
   `(font-lock-doc-face ((t (:foreground ,zenburn-green+4))))
   `(font-lock-function-name-face ((t (:foreground ,zenburn-purple))))
   ...
   `(font-lock-regexp-grouping-construct ((t (:foreground
                                              ,zenburn-yellow :weight bold))))
   `(font-lock-regexp-grouping-backslash ((t (:foreground
                                              ,zenburn-green :weight bold))))
   `(font-lock-string-face ((t (:foreground ,zenburn-red))))
   `(font-lock-type-face ((t (:foreground ,zenburn-blue))))
   `(font-lock-variable-name-face ((t (:foreground ,zenburn-blue))))
   `(font-lock-warning-face ((t (:foreground ,pls-zenburn-orange2
                                             :weight bold))))

   `(c-annotation-face ((t (:inherit font-lock-constant-face))))
;;;;; pianobar
   `(pianobar-mode-prompt-face ((t (:foreground ,zenburn-orange))))
   `(pianobar-mode-time-face ((t (:foreground ,zenburn-yellow))))
   `(pianobar-mode-info-face ((t (:foreground ,zenburn-blue))))
;;;;; newsticker
   ...
   `(newsticker-treeview-new-face ((t (:foreground ,zenburn-blue
                                                   :weight bold))))
   `(newsticker-treeview-obsolete-face ((t (:foreground ,zenburn-red))))
   `(newsticker-treeview-old-face ((t (:foreground ,zenburn-bg+3))))
   `(newsticker-treeview-selection-face ((t (:background ,zenburn-bg-1
                                                         :foreground ,zenburn-yellow))))
;;;; Third-party
;;;;; ace-jump
   `(ace-jump-face-background
     ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg
                      :inverse-video nil))))
   `(ace-jump-face-foreground
     ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg
                      :inverse-video nil))))
;;;;; android mode
...
;;;;; auctex
   ...
   `(font-latex-warning-face ((t (:foreground nil :inherit
                                              font-lock-warning-face))))
   `(font-latex-sectioning-5-face ((t (:foreground ,zenburn-red
                                                   :weight bold ))))
...
;;;;; auto-complete
   `(ac-candidate-face ((t (:background ,zenburn-bg+3 :foreground
                                        ,zenburn-bg-2))))
   `(ac-selection-face ((t (:background ,zenburn-blue-4 :foreground
                                        ,zenburn-fg))))
   `(popup-tip-face ((t (:background ,zenburn-yellow-2 :foreground
                                     ,zenburn-bg-2))))
   `(popup-scroll-bar-foreground-face ((t (:background ,zenburn-blue-5))))
   `(popup-scroll-bar-background-face ((t (:background ,zenburn-bg-1))))
   `(popup-isearch-match ((t (:background ,zenburn-bg :foreground
                                          ,zenburn-fg))))
;;;;; bm
   `(bm-face ((t (:background ,zenburn-yellow-1 :foreground ,zenburn-bg))))
   `(bm-fringe-face ((t (:background ,zenburn-yellow-1 :foreground
                                     ,zenburn-bg))))
   `(bm-fringe-persistent-face ((t (:background ,zenburn-green-1
                                                :foreground ,zenburn-bg))))
   `(bm-persistent-face ((t (:background ,zenburn-green-1 :foreground
                                         ,zenburn-bg))))
;;;;; clojure-test-mode
   `(clojure-test-failure-face ((t (:foreground ,zenburn-orange
                                                :weight bold :underline t))))
   `(clojure-test-error-face ((t (:foreground ,zenburn-red :weight
                                              bold :underline t))))
   `(clojure-test-success-face ((t (:foreground ,zenburn-green+1
                                                :weight bold :underline t))))
;;;;; coq
   `(coq-solve-tactics-face ((t (:foreground nil :inherit
                                             font-lock-constant-face))))
;;;;; ctable
   `(ctbl:face-cell-select ((t (:background ,zenburn-blue :foreground
                                            ,zenburn-bg))))
   `(ctbl:face-continue-bar ((t (:background ,zenburn-bg-05
                                             :foreground ,zenburn-bg))))
   `(ctbl:face-row-select ((t (:background ,zenburn-cyan :foreground
                                           ,zenburn-bg))))
;;;;; diff
...
;;;;; dired+
   ...
   `(diredp-dir-heading ((t (:foreground ,zenburn-blue :background
                                         ,zenburn-bg-1))))
...
;;;;; ediff
   `(ediff-current-diff-A ((t (:foreground ,zenburn-fg :background
                                           ,zenburn-red-4))))
   `(ediff-current-diff-Ancestor ((t (:foreground ,zenburn-fg
                                                  :background ,zenburn-red-4))))
   `(ediff-current-diff-B ((t (:foreground ,zenburn-fg :background
                                           ,zenburn-green-1))))
   `(ediff-current-diff-C ((t (:foreground ,zenburn-fg :background
                                           ,zenburn-blue-5))))
   ...
   `(ediff-fine-diff-A ((t (:foreground ,zenburn-fg :background
                                        ,zenburn-red-2 :weight bold))))
   `(ediff-fine-diff-Ancestor ((t (:foreground ,zenburn-fg :background
                                               ,zenburn-red-2 weight bold))))
   `(ediff-fine-diff-B ((t (:foreground ,zenburn-fg :background
                                        ,zenburn-green :weight bold))))
   `(ediff-fine-diff-C ((t (:foreground ,zenburn-fg :background
                                        ,zenburn-blue-3 :weight bold ))))
...
;;;;; erc
   ...
   `(erc-prompt-face ((t (:foreground ,zenburn-orange :background
                                      ,zenburn-bg :weight bold))))
   `(erc-timestamp-face ((t (:foreground ,zenburn-green+4))))
   `(erc-underline-face ((t (:underline t))))
;;;;; ert
   `(ert-test-result-expected ((t (:foreground ,zenburn-green+4
                                               :background ,zenburn-bg))))
   `(ert-test-result-unexpected ((t (:foreground ,zenburn-red
                                                 :background ,zenburn-bg))))
;;;;; eshell
   ...
   `(eshell-ls-executable ((t (:foreground ,zenburn-red+1 :weight
                                           bold))))
   ...
   `(flymake-errline
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,zenburn-red)
                   :inherit unspecified :foreground unspecified
...
;;;;; full-ack
   ...
   `(ack-match ((t (:foreground ,zenburn-orange :background
                                ,zenburn-bg-1 :weight bold))))
;;;;; git-gutter
   `(git-gutter:added ((t (:foreground ,zenburn-green :weight bold
                                       :inverse-video t))))
   `(git-gutter:deleted ((t (:foreground ,zenburn-red :weight bold
                                         :inverse-video t))))
   `(git-gutter:modified ((t (:foreground ,zenburn-magenta :weight
...
;;;;; gnus
   ...
   `(gnus-summary-normal-ticked ((t (:foreground ,zenburn-orange
                                                 :weight bold))))
...
;;;;; helm
   `(helm-header
     ((t (:foreground , zenburn-bg-1 ;;zenburn-green
                        :background ,zenburn-blue-3
                        :underline nil
                        :box nil))))
   `(helm-source-header
     ((t (:foreground ,zenburn-yellow
                      ...
                      :underline nil
                      :weight bold
                      :height 120 ;; 180 on osx... why?
                      :box (:line-width 4  :color ,zenburn-bg-2 :style nil)))))
   ;; :box (:line-width -1 :style released-button)))))
   `(helm-selection ((t (:background ,zenburn-bg+1 :underline nil))))
   `(helm-selection-line ((t (:background ,zenburn-bg+1))))
   `(helm-visible-mark ((t (:foreground ,zenburn-bg :background
                                        ,zenburn-yellow-2))))
   `(helm-candidate-number ((t (:foreground ,zenburn-green+4
                                            :background ,zenburn-bg-1))))
   ...
   `(helm-bookmark-man ((t (:foreground ,zenburn-yellow :background
                                        ,zenburn-bg))))
   `(helm-bookmark-w3m ((t (:foreground ,zenburn-magenta :background
                                        ,zenburn-bg))))
   `(helm-buffer-not-saved ((t (:foreground ,zenburn-red :background
                                            ,zenburn-bg))))
   `(helm-buffer-process ((t (:foreground ,zenburn-cyan :background
                                          ,zenburn-bg))))
   `(helm-buffer-saved-out ((t (:foreground ,zenburn-fg :background
                                            ,zenburn-bg))))
   `(helm-buffer-size ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg))))
   `(helm-ff-directory ((t (:foreground ,zenburn-cyan :background
                                        ,zenburn-bg :weight bold))))
   `(helm-ff-file ((t (:foreground ,zenburn-fg :background ,zenburn-bg
                                   :weight normal))))
   `(helm-ff-executable ((t (:foreground ,zenburn-green+2 :background
                                         ,zenburn-bg :weight normal))))
   `(helm-ff-invalid-symlink ((t (:foreground ,zenburn-red :background
                                              ,zenburn-bg :weight bold))))
   `(helm-ff-symlink ((t (:foreground ,zenburn-yellow :background
                                      ,zenburn-bg :weight bold))))
   `(helm-ff-prefix ((t (:foreground ,zenburn-bg :background
                                     ,zenburn-yellow :weight normal))))
   `(helm-grep-cmd-line ((t (:foreground ,zenburn-cyan :background
                                         ,zenburn-bg))))
...
;;;;; ido-mode
   ...
   `(ido-indicator ((t (:foreground ,zenburn-yellow :background
                                    ,zenburn-red-4))))
;;;;; iedit-mode
...
;;;;; ledger-mode
   `(ledger-font-payee-uncleared-face ((t (:foreground ,zenburn-red-1
                                                       :weight bold))))
   `(ledger-font-payee-cleared-face ((t (:foreground ,zenburn-fg
                                                     :weight normal))))
   `(ledger-font-xact-highlight-face ((t (:background ,zenburn-bg+1))))
   `(ledger-font-pending-face ((t (:foreground ,zenburn-orange weight:
                                               normal))))
   ...
   `(ledger-font-reconciler-uncleared-face ((t (:foreground
                                                ,zenburn-red-1 :weight bold))))
   `(ledger-font-reconciler-cleared-face ((t (:foreground ,zenburn-fg
                                                          :weight normal))))
   `(ledger-font-reconciler-pending-face ((t (:foreground
                                              ,zenburn-orange :weight normal))))
   `(ledger-font-report-clickable-face ((t (:foreground
                                            ,zenburn-orange :weight normal))))
;;;;; linum-mode
...
;;;;; macrostep
   ...
   `(macrostep-macro-face
     ((t (:underline t))))
;;;;; magit
   `(magit-section-title ((t (:foreground ,zenburn-yellow :weight bold :style nil :box nil))))
   `(magit-branch ((t (:foreground ,zenburn-orange :weight bold :style nil :box nil))))
   `(magit-item-highlight ((t (:background ,zenburn-bg+1))))
   `(magit-log-author ((t (:foreground, zenburn-yellow))))
   `(magit-log-sha1 ((t (:foreground, zenburn-blue))))
   `(magit-tag ((t (:foreground, pls-zenburn-green2 :style nil :box nil))))
   `(magit-key-mode-button-face ((t (:foreground, zenburn-orange))))
...
;;;;; mic-paren
   `(paren-face-match ((t (:foreground ,zenburn-cyan :background
                                       ,zenburn-bg :weight bold))))
   `(paren-face-mismatch ((t (:foreground ,zenburn-bg :background
                                          ,zenburn-magenta :weight bold))))
   `(paren-face-no-match ((t (:foreground ,zenburn-bg :background
                                          ,zenburn-red :weight bold))))
;;;;; mingus
...
;;;;; org-mode
   ...
   `(org-column-title ((t (:background ,zenburn-bg-1 :underline t
                                       :weight bold))))
   `(org-mode-line-clock ((t (:foreground ,zenburn-fg :background
                                          ,zenburn-bg-1))))
   `(org-mode-line-clock-overrun ((t (:foreground ,zenburn-bg
...
;;;;; perspective
   `(persp-selected-face ((t (:foreground ,zenburn-yellow-2 :inherit
                                          mode-line))))
;;;;; powerline
   ...
   `(powerline-inactive1 ((t (:background ,zenburn-bg+1 :inherit
                                          mode-line-inactive))))
   `(powerline-inactive2 ((t (:background ,zenburn-bg+3 :inherit
                                          mode-line-inactive))))
;;;;; proofgeneral
   `(proof-active-area-face ((t (:underline t))))
   `(proof-boring-face ((t (:foreground ,zenburn-fg :background
                                        ,zenburn-bg+2))))
   ...
   `(proof-declaration-name-face ((t (:inherit font-lock-keyword-face
                                               :foreground nil))))
   `(proof-eager-annotation-face ((t (:foreground ,zenburn-bg
                                                  :background ,zenburn-orange))))
   `(proof-error-face ((t (:foreground ,zenburn-fg :background
                                       ,zenburn-red-4))))
   `(proof-highlight-dependency-face ((t (:foreground ,zenburn-bg
                                                      :background ,zenburn-yellow-1))))
   `(proof-highlight-dependent-face ((t (:foreground ,zenburn-bg
                                                     :background ,zenburn-orange))))
   `(proof-locked-face ((t (:background ,zenburn-blue-5))))
   `(proof-mouse-highlight-face ((t (:foreground ,zenburn-bg
                                                 :background ,zenburn-orange))))
   ...
   `(proof-tacticals-name-face ((t (:inherit font-lock-constant-face
                                             :foreground nil :background ,zenburn-bg))))
   `(proof-tactics-name-face ((t (:inherit font-lock-constant-face
                                           :foreground nil :background ,zenburn-bg))))
   `(proof-warning-face ((t (:foreground ,zenburn-bg :background
                                         ,zenburn-yellow-1))))
;;;;; rainbow-delimiters
...
;;;;; show-paren
   `(show-paren-mismatch ((t (:foreground ,zenburn-red+1 :background
                                          ,zenburn-bg+3 :weight bold))))
   `(show-paren-match ((t (:background ,zenburn-bg+3 :weight bold))))
;;;;; smartparens
   `(sp-show-pair-mismatch-face ((t (:foreground ,zenburn-red+1
                                                 :background ,zenburn-bg+3 :weight bold))))
...
;;;;; speedbar
   ...
   `(speedbar-highlight-face ((t (:foreground ,zenburn-bg :background
                                              ,zenburn-green+2))))
   `(speedbar-selected-face ((t (:foreground ,zenburn-red))))
   `(speedbar-separator-face ((t (:foreground ,zenburn-bg :background
                                              ,zenburn-blue-1))))
...
;;;;; undo-tree
   `(undo-tree-visualizer-active-branch-face ((t (:foreground
                                                  ,zenburn-fg+1 :weight bold))))
...
;;;;; web-mode
   ...
   `(web-mode-css-pseudo-class-face ((t (:foreground ,zenburn-green+3
                                                     :weight bold))))
...
;;;;; whitespace-mode
   `(whitespace-space ((t (:background ,zenburn-bg+1 :foreground
                                       ,zenburn-bg+1))))
   `(whitespace-hspace ((t (:background ,zenburn-bg+1 :foreground
                                        ,zenburn-bg+1))))
   ...
   `(whitespace-line ((t (:background ,zenburn-bg :foreground
                                      ,zenburn-magenta))))
   `(whitespace-space-before-tab ((t (:background ,zenburn-orange
                                                  :foreground ,zenburn-orange))))
   `(whitespace-indentation ((t (:background ,zenburn-yellow
                                             :foreground ,zenburn-red))))
   `(whitespace-empty ((t (:background ,zenburn-yellow))))
   `(whitespace-space-after-tab ((t (:background ,zenburn-yellow
                                                 :foreground ,zenburn-red))))
;;;;; wanderlust
...
;;;;; yascroll
   ...
   `(yascroll:thumb-fringe ((t (:background ,zenburn-bg-1 :foreground
                                            ,zenburn-bg-1))))
   ))
...
(pls-zenburn-with-color-variables
  (custom-theme-set-variables
   'pls-zenburn
;;;;; ansi-color
   `(ansi-color-names-vector [,zenburn-bg ,zenburn-red ,zenburn-green
                                          ,zenburn-yellow
                                          ,zenburn-blue
                                          ,zenburn-magenta ,zenburn-cyan ,zenburn-fg])
...
(defvar pls-zenburn-add-font-lock-keywords nil
...
(defvar pls-zenburn-colors-font-lock-keywords nil)
...
;;             `((,(regexp-opt (mapcar 'car pls-zenburn-colors-alist) 'words)
;;                (0 (rainbow-colorize-by-assoc pls-zenburn-colors-alist))))))
